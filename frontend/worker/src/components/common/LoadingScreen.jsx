...
const styles = `
  ...
  .scooter-wrap {
    animation: moveScooter 0.9s linear 1 forwards;
      ...
      {spokes.map((angle) => {
        ...
        return (
          <React.Fragment key={angle}>
            <line
              x1={cx + cos * 5}  y1={cy + sin * 5}
              x2={cx + cos * 15} y2={cy + sin * 15}
 ...
 *
 * Props:
 *   onFinish  — called when the scooter animation completes (use instead of navigate)
 *
 * If you prefer React Router, replace `onFinish?.()` with `navigate('/next-page')`
